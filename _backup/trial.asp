...
' Check if login exists already
	...
	if not myrs.eof then 
		...
		if myrs2.eof then 
			MyRS2.AddNew()
			MyRS2("ExpireDate") = DateAdd("d",14,now())
								...
								<div class="row">
									<div class="col-md-12">
										<div class="SiteAddress text-center" id="SiteAddress">
											<hr>
											<a href="http://<%= request.form("li_1_description") %>.usebuild.co" class="SiteAddressSpan" id="SiteAddressSpan"><%= request.form("li_1_description")  & ".usebuild.co" %></a>
											<hr>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="Actions text-center" id="Actions">
											...
											<button class="btn btn-success btn-lg" id="GoToSite" data-siteaddress='http://<%= request.form("li_1_description") %>.usebuild.co'>Take me there now!</button>
