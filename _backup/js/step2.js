...
var CaptureTwoCheckoutPostData = function() {
	...
	if (SelectedPricingPlan === "monthly") {
	...
	if (SelectedPricingPlan !== "free") {
		...
		if (Product2Name !== undefined) {
			...
			TwoCheckoutPostData.li_1_tangible = "N";
			TwoCheckoutPostData.li_1_name = Product2Name;
			TwoCheckoutPostData.li_1_quantity = Product2Quantity;
			TwoCheckoutPostData.li_1_price = Product2Price;
			TwoCheckoutPostData.li_1_duration = Product2Duration;

			TwoCheckoutPostData.li_2_type = "product";
			TwoCheckoutPostData.li_2_name = "Your chosen subdomain";
			TwoCheckoutPostData.li_2_price = 0;
			TwoCheckoutPostData.li_2_description = mySubDomain;	
...
var ValidateContactForm = function() {
	...
	ValidateContactForm = $("#contactForm").validate({
...
function changeFormActions() {
    selectionType == "new-domain" ? ($("#proceed-type-domain").removeClass("hidden"), $("#proceed-type-payment").addClass("hidden")) : selectionType == "free-subdomain" || selectionType == "existing-domain" ? ($("#proceed-type-domain").addClass("hidden"), $("#proceed-type-payment").removeClass("hidden")) : $("#proceed-actions").addClass("hidden");
}
