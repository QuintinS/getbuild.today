...
if request.querystring("total") = "150.00" then
	...
	ChockingHazard = UCASE(MD5("takeitlikeit" & "2140176" & request.form("order_number")  & "20.00"))
end if
...
myMail.TextBody="User Created (MakeUser.asp):" & vbcrlf & myMsg 
...
' Check if login exists already
	...
	'	NewPass = generatePassword(8)
		...
		if myrs2.eof then 
			...
			response.write "<!-- The New User AccountID: " & NewVoAccountID & "<BR>Template ID: " & MyRS2("TemplateID") & "-->"
		end if
