								...
								<div class="row">
									<div class="col-md-12">
										<div class="SiteAddress text-center" id="SiteAddress">
											<hr>
											<a href="http://<%= request.querystring("li_1_description") %>.usebuild.co" class="SiteAddressSpan" id="SiteAddressSpan"><%= request.querystring("li_1_description")  & ".usebuild.co" %></a>
											<hr>
										</div>
									</div>
									...
									<div class="col-md-12">
										<div class="Actions text-center" id="Actions">
											...
											<button class="btn btn-success btn-lg" id="GoToSite" data-siteaddress='http://<%= request.querystring("li_1_description") %>.usebuild.co'>Take me there now!</button>
